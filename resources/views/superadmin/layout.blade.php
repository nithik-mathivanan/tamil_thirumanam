				...
				<div class="container-fluid">
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
							...
							<ul class="dropdown-menu notif-box" aria-labelledby="navbarDropdown">
								...
								<li>
									<div class="notif-center">
										...
										<a href="#">
											<div class="notif-img"> 
												<img src="{{asset('public/admin_files/img/profile.jpg')}}" alt="Img Profile">
											</div>
											<div class="notif-content">
												<span class="block">
						...
						<li class="nav-item dropdown">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false"> <img src="{{asset('public/admin_files/img/profile.jpg')}}" alt="user-img" width="36" class="img-circle"><span >{{Auth::guard('admin')->user()->name}}</span> </a>
							<ul class="dropdown-menu dropdown-user">
								<li>
									<div class="user-box">
										<div class="u-img"><img src="{{asset('public/admin_files/img/profile.jpg')}}" alt="user"></div>
										<div class="u-text">
									...
									<div class="dropdown-divider"></div>
									<a class="dropdown-item" href="{{route('admin-signout')}}"><i class="fa fa-power-off"></i> Logout</a>
								</ul>
								<!-- /.dropdown-user -->
							</li>
						</ul>
...
<script src="{{asset('public/js/plugin/chartist/chartist.min.js')}}"></script>
<script src="{{asset('public/js/plugin/chartist/plugin/chartist-plugin-tooltip.min.js')}}"></script>
<script src="{{asset('public/js/plugin/bootstrap-notify/bootstrap-notify.min.js')}}"></script>
<script src="{{asset('public/js/plugin/bootstrap-toggle/bootstrap-toggle.min.js')}}"></script>
<script src="{{asset('public/js/plugin/jquery-mapael/jquery.mapael.min.js')}}"></script>
<script src="{{asset('public/js/plugin/jquery-mapael/maps/world_countries.min.js')}}"></script>
