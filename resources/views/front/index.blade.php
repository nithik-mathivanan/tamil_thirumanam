        ...
        <div class="hom-ban-sli">
            <div>
                <ul class="ban-sli">
                    <li>
                        <div class="image">
                            <img src="{{asset('users_assets/images/ban-bg.jpg')}}" alt="" loading="lazy">
                        </div>
                    </li>
                    <li>
                        <div class="image">
                            <img src="{{asset('users_assets/images/banner.jpg')}}" alt="" loading="lazy">
                        </div>
                    </li>
                </ul>
            </div>
                        ...
                        <ul class="hom-qui-acc-sli">
                            <li>
                                <div class="wow fadeInUp hacc hacc1" data-wow-delay="0.1s">
                                    <div class="con">
                                        <img src="{{asset('users_assets/images/icon/user.png')}}" alt="" loading="lazy">
                            ...
                            <li>
                                <div class="wow fadeInUp hacc hacc2" data-wow-delay="0.2s">
                                    <div class="con">
                                        <img src="{{asset('users_assets/images/icon/gate.png')}}" alt="" loading="lazy">
                                        <h4>Wedding</h4>
                                        <p>1200+ Profiles</p>
                            ...
                            <li>
                                <div class="wow fadeInUp hacc hacc3" data-wow-delay="0.3s">
                                    <div class="con">
                                        <img src="{{asset('users_assets/images/icon/photo-camera.png')}}" alt="" loading="lazy">
                                        <h4>Photography</h4>
                                        <p>1200+ Profiles</p>
                            ...
                            <li>
                                <div class="wow fadeInUp hacc hacc4" data-wow-delay="0.3s">
                                    <div class="con">
                                        <img src="{{asset('users_assets/images/icon/hall.png')}}" alt="" loading="lazy">
                                        <h4>Catering</h4>
                                        <p>1200+ Profiles</p>
                        ...
                        <ul class="slider3">
                            <li>
                                <div class="cus-revi-box">
                                    <div class="revi-im">
                                        <img src="{{asset('users_assets/images/user/1.jpg')}}" alt="" loading="lazy">
                    ...
                    <ul>
                        <li>
                            <div class="animate animate__animated animate__slower" data-ani="animate__flipInX"
                                data-dely="0.1">
                                <img src="{{asset('users_assets/images/icon/prize.png')}}" alt="" loading="lazy">
                        ...
                        <li>
                            <div class="animate animate__animated animate__slower" data-ani="animate__flipInX"
                                data-dely="0.3">
                                <img src="{{asset('users_assets/images/icon/trust.png')}}" alt="" loading="lazy">
                                <h4>Most trusted</h4>
                        ...
                        <li>
                            <div class="animate animate__animated animate__slower" data-ani="animate__flipInX"
                                data-dely="0.6">
                                <img src="{{asset('users_assets/images/icon/rings.png')}}" alt="" loading="lazy">
                                <h4>2000+ weddings</h4>
