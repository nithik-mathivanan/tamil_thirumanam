                                    ...
                                    <form action="{{route('profile_details.profile_details_process')}}" method="post">
                                        ...
                                        <div class="edit-pro-parti">
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter your full name"
                                                    name="fullname" value="{{$list->fullname}}">
                                            </div>

                                            <div class="col-md-6 form-group">
                                                <label class="lb">Date of Birth</label>
                                                <input type="date" class="form-control" id="dob" placeholder="Enter DOB" name="dob" value="{{$list->dob}}" onchange="validateDate()" >
                                        ...
                                        <div class="edit-pro-parti">
                                            ...
                                            <select type="text" class="form-control" name="mother_tongue"
                                                ...
                                                @if($list->mothertongue!=null)
                                                <option value="{{$list->mothertongue}}">{{$list->mothertongue}}</option>
                                                @else
                                                <option value="">Select</option>
                                                @endif
                                                ...
                                                @if($list->caste!=null)
                                                <option value="{{$list->caste}}">{{$list->caste}}</option>
                                                @else
                                                <option value="">Select</option>
                                                @endif
                                        ...
                                        <div class="edit-pro-parti">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select chosen-select" data-placeholder="Select your currency" name="currency" id="fromCurrency" >
                                                    ...
                                                    <option value="{{$list->currency}}">{{$list->currency}}</option>
                                                    @else
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Type Annual Income in INR" name="salary" value="{{$list->salary}}">
                                                </div>
                                                <div class="col-md-6 form-group">
                                        ...
                                        <div class="edit-pro-parti">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="fname" value="{{$list->father_name}}">
                                                </div>
                                                <div class="col-md-6 form-group">
                                                    <label class="lb">Mother's Name:</label>
                                                    <input type="text" class="form-control" name="mname" value="{{$list->mother_name}}">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6 form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <select class="form-select chosen-select" id="state" name="state" onchange="filterDistricts()">
                                                    @if($list->state!=null)
                                                    <option value="{{$list->state}}">{{$list->state}}</option>
                                                    @else
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="pincode" value="{{$list->pincode}}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="edit-pro-parti">
                                            ...
                                            <div class="row">
                                                ...
                                                <option value="{{$list->smokinghabit}}">{{$list->smokinghabit}}</option>
                                                @else
                                                <option value="">Select</option>
                                                @endif
                                                <option value="No">No</option>
                                                ...
                                                @if($list->hobbies!=null)
                                                <option value="{{$list->hobbies}}">{{$list->hobbies}}</option>
                                                @else
                                                <option value="">Select</option>
                                                @endif
