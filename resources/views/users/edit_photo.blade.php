                            ...
                            <div class="form-login">
                                    <form action="{{route('preferred_details.preferred_details_process')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group" style="display: none;">
                                            ...
                                            <input type="text" class="form-control" name="pcustomer_id" value="{{Auth::user()->rand_id}}" readonly>
                                         ...
                                         <div class="container">
                                            ...
                                            <div id="exs-image_show">
                                                        ...
                                                        @foreach(json_decode($photos->images) as $photo)
                                                       
                                                        <div class="ml-2">
                                                              <img src="{{asset('public/images/uploads')}}/{{$photo}}" height="200px">
                                                        </div>
