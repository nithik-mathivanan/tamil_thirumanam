    ...
    <div class="col-md-12 col-lg-6 col-xl-4 db-sec-com">
        ...
        <div class="db-pro-stat">
            ...
            <div class="db-plan-card">
                <img src="{{asset('users_assets/images/icon/plan.png')}}" alt="">
            </div>
        ...
        <h2 class="db-tit">Recent chat list</h2>
            <div class="db-pro-stat">
                <div class="db-inte-prof-list db-inte-prof-chat">
                    <ul>
                        <li>
                            <div class="db-int-pro-1"> <img src="{{asset('users_assets/images/profiles/men6.jpg')}}" alt=""> </div>
                        ...
                        <div class="tab-content">
                            <div id="home" class="container tab-pane active"><br>
                              <div class="db-inte-prof-list">
                                    <ul>
                                        <li>
                                            <div class="db-int-pro-1"> <img src="{{asset('users_assets/images/profiles/men1.jpg')}}" alt=""> <span class="badge bg-primary user-pla-pat">Platinum user</span></div>
                                            <div class="db-int-pro-2">
                                                <h5>John Smith</h5> 
                                                <ol class="poi">
                            ...
                            <div id="menu1" class="container tab-pane fade"><br>
                                <div class="db-inte-prof-list">
                                    <ul>
                                        <li>
                                            <div class="db-int-pro-1"> <img src="{{asset('users_assets/images/profiles/men5.jpg')}}" alt=""> </div>
                                            <div class="db-int-pro-2">
                                                <h5>John Smith</h5> 
                                                <ol class="poi">
                                                    <li>City: <strong>Illunois</strong></li>
                            ...
                            <div id="menu2" class="container tab-pane fade"><br>
                                <div class="db-inte-prof-list">
                                    <ul>
                                        <li>
                                            <div class="db-int-pro-1"> <img src="{{asset('users_assets/images/profiles/men1.jpg')}}" alt=""> </div>
                                            <div class="db-int-pro-2">
                                                <h5>John Smith</h5> 
                                                <ol class="poi">
                                                    <li>City: <strong>Illunois</strong></li>
