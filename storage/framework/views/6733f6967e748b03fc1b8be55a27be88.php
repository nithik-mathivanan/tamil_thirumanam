...
<?php $__env->startSection('container'); ?>
   ...
   <section>
            ...
            <div class="hom-head">
                <div class="container">
                    <div class="row">
                        <div class="hom-ban">
                            <div class="ban-tit">
                                <span><i class="no1">#1</i> TamilThirumanam.com</span>
                                        ...
                                        <li class="sr-age">
                                            <div class="form-group">
                                                ...
                                                <select class="chosen-select">
                                                    ...
                                                    <option value="">18 to 25</option>
                                                    <option value="">25 to 30</option>
                                                    <option value="">31 to 35</option>
                                                    <option value="">35 to 40</option>
                                                    <option value="">41 to 45</option>
                                                    <option value="">45 to 50</option>
    ...
    <!-- END <a href="sign-up.html" class="cta-3">Register Now</a>-->
        ...
        <div class="hom-ban-sli">
            <div>
                <ul class="ban-sli">
                    <li>
                        <div class="image">
                            <img src="<?php echo e(asset('users_assets/images/ban-bg.jpg')); ?>" alt="" loading="lazy">
                        </div>
                    </li>
                    <li>
                        <div class="image">
                            <img src="<?php echo e(asset('users_assets/images/banner.jpg')); ?>" alt="" loading="lazy">
                        </div>
                    </li>
                </ul>
            </div>
                        ...
                        <ul class="hom-qui-acc-sli">
                            <li>
                                <div class="wow fadeInUp hacc hacc1" data-wow-delay="0.1s">
                                    <div class="con">
                                        <img src="<?php echo e(asset('users_assets/images/icon/user.png')); ?>" alt="" loading="lazy">
                            ...
                            <li>
                                <div class="wow fadeInUp hacc hacc2" data-wow-delay="0.2s">
                                    <div class="con">
                                        <img src="<?php echo e(asset('users_assets/images/icon/gate.png')); ?>" alt="" loading="lazy">
                                        <h4>Wedding</h4>
                                        <p>1200+ Profiles</p>
                            ...
                            <li>
                                <div class="wow fadeInUp hacc hacc3" data-wow-delay="0.3s">
                                    <div class="con">
                                        <img src="<?php echo e(asset('users_assets/images/icon/photo-camera.png')); ?>" alt="" loading="lazy">
                                        <h4>Photography</h4>
                                        <p>1200+ Profiles</p>
                            ...
                            <li>
                                <div class="wow fadeInUp hacc hacc4" data-wow-delay="0.3s">
                                    <div class="con">
                                        <img src="<?php echo e(asset('users_assets/images/icon/hall.png')); ?>" alt="" loading="lazy">
                                        <h4>Catering</h4>
                                        <p>1200+ Profiles</p>
                        ...
                        <ul class="slider3">
                            <li>
                                <div class="cus-revi-box">
                                    <div class="revi-im">
                                        <img src="<?php echo e(asset('users_assets/images/user/1.jpg')); ?>" alt="" loading="lazy">
                    ...
                    <ul>
                        <li>
                            <div class="animate animate__animated animate__slower" data-ani="animate__flipInX"
                                data-dely="0.1">
                                <img src="<?php echo e(asset('users_assets/images/icon/prize.png')); ?>" alt="" loading="lazy">
                        ...
                        <li>
                            <div class="animate animate__animated animate__slower" data-ani="animate__flipInX"
                                data-dely="0.3">
                                <img src="<?php echo e(asset('users_assets/images/icon/trust.png')); ?>" alt="" loading="lazy">
                                <h4>Most trusted</h4>
                        ...
                        <li>
                            <div class="animate animate__animated animate__slower" data-ani="animate__flipInX"
                                data-dely="0.6">
                                <img src="<?php echo e(asset('users_assets/images/icon/rings.png')); ?>" alt="" loading="lazy">
                                <h4>2000+ weddings</h4>
...
<?php echo $__env->make('front/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/us59y3x253l9/public_html/tamilthirumanam.com/resources/views/front/index.blade.php ENDPATH**/ ?>