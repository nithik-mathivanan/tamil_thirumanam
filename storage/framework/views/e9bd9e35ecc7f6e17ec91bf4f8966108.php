									...
									<div class="card-body">
										...
										<table class="table table-striped mt-3">
											...
											<tbody>
												...
												<tr>
													<td><?php echo e($i); ?></td>
													<td><?php echo e($data->familytype); ?></td>
													<td>
														<div class="group">
													...
													<td>
														<a href="<?php echo e(url('admin/familytype/delete')); ?>/<?php echo e($data->id); ?>">
...
<!-- Create Model -->
				<div class="modal fade" id="addModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<form method="post" action="<?php echo e(route('store-familytype')); ?>">
...
<!-- Edit Model -->
				<div class="modal fade" id="editModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<form method="post" action="<?php echo e(route('update-familytype')); ?>">
						<?php echo e(csrf_field()); ?>
					  ...
					  <div class="modal-dialog" role="document">
					    <div class="modal-content">
					      ...
					      <div class="modal-body">
					          ...
					          <div class="form-group">
					            <label for="message-text" class="col-form-label">Family Type</label>
					            <input class="form-control" name="familytype" id="familystatus" placeholder="Enter Family Type" required>
					          </div>
					...
					<script type="text/javascript">
						...
						function edit(id){
							console.log(id);
							$.ajax({
			                    url:"<?php echo e(url('admin/familytype/edit')); ?>/"+id,
			                    type:'GET',
						...
						$(document).ready(function() {
								...
								if($(this).prop('checked')) {
								        $.ajax({
						                    url:"<?php echo e(url('admin/familytype/status')); ?>/"+id+'/0',
						                    type:'GET',
						                   	success:function(response){
						                    	Swal.fire({
								        ...
								        $.ajax({
						                    url:"<?php echo e(url('admin/familytype/status')); ?>/"+id+'/1',
						                    type:'GET',
						                   	success:function(response){
						                    	Swal.fire({
...
<?php echo $__env->make('superadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tamil_thirumanam\resources\views/superadmin/familytype/index.blade.php ENDPATH**/ ?>