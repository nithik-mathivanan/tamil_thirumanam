					...
					<div class="container-fluid">
						...
						<div class="row table-content">
							<div class="col-md-8">
                                ...
                                <?php endif; ?>
									<form action="<?php echo e(route('store-religion')); ?>"   method="post" enctype="multipart/form-data" >
...
<?php echo $__env->make('superadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tamil_thirumanam_user\resources\views/superadmin/religion/create.blade.php ENDPATH**/ ?>