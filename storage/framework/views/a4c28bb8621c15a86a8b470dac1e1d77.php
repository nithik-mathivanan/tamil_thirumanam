										...
										<table class="table table-striped mt-3">
											...
											<tbody>
												...
												<tr>
													...
													<td><?php echo e($data->fips_code); ?></td>
					...
					<script type="text/javascript">
						$(document).ready(function() {
								...
								if($(this).prop('checked')) {
								        $.ajax({
						                    url:"<?php echo e(url('admin/states/status')); ?>/"+id+'/0',
						                    type:'GET',
								        ...
								        $.ajax({
						                    url:"<?php echo e(url('admin/states/status')); ?>/"+id+'/1',
						                    type:'GET',
						                   	success:function(response){
						                    	Swal.fire({
...
<?php echo $__env->make('superadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tamil_thirumanam\resources\views/superadmin/states/index.blade.php ENDPATH**/ ?>