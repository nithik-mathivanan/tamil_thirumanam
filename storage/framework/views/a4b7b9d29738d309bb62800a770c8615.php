            ...
            <div class="container">
                <div class="row">
                        ...
                        <div class="filt-com lhs-cate">
                            ...
                            <div class="form-group">
                                <select class="chosen-select">
                                    <option>Caste</option>
                                    <option value="">Any</option>
                                    <?php $__currentLoopData = $matching_profile; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($pro->caste); ?>"><?php echo e($pro->caste); ?></option>
                        ...
                        <div class="filt-com lhs-cate">
                            ...
                            <div class="form-group">
                                <select class="chosen-select" name="addjbmaincate">
                                    ...
                                    <option value="">Any</option>
                                    <<?php $__currentLoopData = $matching_profile; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($pro->district); ?>"><?php echo e($pro->district); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="col-md-9">
                        ...
                        <?php $__currentLoopData = $match; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                            
                            <ul>                                
                                ...
                                <li>
                                    <div class="all-pro-box user-avil-onli" data-useravil="avilyes"
                                        ...
                                        <div class="pro-img">
                                            ...
                                            <a href="#">
                                                <img src="<?php echo e(asset('public/images/uploads/')); ?>/<?php echo e(json_decode($list->getImages->images)[0]); ?>" alt="">
                                            </a>
                                        ...
                                        <div class="pro-detail">
                                            <h4><a href="#"><?php echo e($list->fullname); ?></a></h4>
                                            <div class="pro-bio">
                                                <span><?php echo e($list->education); ?></span>
                                                <span><?php echo e($list->job_type); ?></span>
                                                <span><?php echo e($list->age); ?> Yeard old</span>
                                                <span>Height: <?php echo e($list->height); ?>cm </span>
                                            </div>
                                            <div class="links">
                                                <span  class="profile-label">Chat now</span>
                                                <a href="#!" class="profile-label">WhatsApp</a>
                                                
                                                <a class="profile-label" href="<?php echo e(url('/user/profile_detail_view')); ?>/<?php echo e($list->user_id); ?>">More detaiils</a>
                                            </div>
                                        </div>
                                        <!--END PROFILE NAME-->
                                        <!--SAVE-->
    ...
    <div class="modal fade" id="sendInter">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <?php if($profileid == $list->rand_id): ?>
                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title seninter-tit">Send interest to <span class="intename2"><?php echo e($list->fullname); ?></span></h4>
                ...
                <div class="modal-body seninter">
                    ...
                    <div class="rhs">
                        <h4>Permissions: <span class="intename2"><?php echo e($list->fullname); ?></span> Can able to view your details</h4>
                    </div>
                </div>
                <?php endif; ?>
                <form action="<?php echo e(route('matching_profiles.expressinterests', $list->id)); ?>" method="post">
                <!-- Modal footer -->
...
<?php echo $__env->make('users/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tamil_thirumanam\resources\views/users/matching_profiles.blade.php ENDPATH**/ ?>