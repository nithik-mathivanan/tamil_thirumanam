...
<div class="content">
					<div class="container-fluid">
						<h4 class="page-title" id="ddd">Cities</h4>
										...
										<table class="table table-striped mt-3">
											...
											<tbody>
												...
												<tr>
													...
													<td><?php echo e($data->getCountry->name); ?></td>
													<td>
														<div class="group">
					...
					<script type="text/javascript">
						$(document).ready(function() {
								...
								if($(this).prop('checked')) {
								        $.ajax({
						                    url:"<?php echo e(url('admin/cities/status')); ?>/"+id+'/0',
						                    type:'GET',
						                   	success:function(response){
						                    	Swal.fire({
													  title: 'cities Activated!!',
													  text: 'cities status changed successfully',
													  icon: 'success',
								        ...
								        $.ajax({
						                    url:"<?php echo e(url('admin/cities/status')); ?>/"+id+'/1',
						                    type:'GET',
						                   	success:function(response){
						                    	Swal.fire({
												  title: 'cities Deactivated!!!',
												  text: 'cities status changed successfully..',
												  icon: 'error',
												  confirmButtonText: 'OK'
												});
...
<?php echo $__env->make('superadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tamil_thirumanam\resources\views/superadmin/cities/index.blade.php ENDPATH**/ ?>