            ...
            <div class="ban-inn ab-ban">
                <div class="container">
                    <div class="row">
                        <div class="hom-ban">
                            <div class="ban-tit">
                                <span><i class="no1">#1</i> TamilThirumanam</span>
                                <h1>About us</h1>
            ...
            <div class="container">
                <div class="row">
                    <ul>
                        <li>
                            <div>
                                <img src="<?php echo e(asset('users_assets/images/icon/prize.png')); ?>" alt="">
                        ...
                        <li>
                            <div>
                                <img src="<?php echo e(asset('users_assets/images/icon/trust.png')); ?>" alt="">
                                <h4>Most trusted</h4>
                                <p>The most trusted wedding matrimony brand</p>
                            </div>
                        </li>
                        <li>
                            <div>
                                <img src="<?php echo e(asset('users_assets/images/icon/rings.png')); ?>" alt="">
                                <h4>2000+ weddings</h4>
                                <p>The most trusted wedding matrimony brand</p>
                            </div>
                        </li>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="ab-wel-lhs">
                            ...
                            <img src="<?php echo e(asset('users_assets/images/about/1.jpg')); ?>" alt="" class="ab-wel-1">
                            <img src="<?php echo e(asset('users_assets/images/about/2.jpg')); ?>" alt="" class="ab-wel-2">
                    ...
                    <div class="col-lg-6">
                        <div class="ab-wel-rhs">
                            <div class="ab-wel-tit">
                                <h2>Welcome to <em>TAMILTHIRUMANAM.COM</em></h2>
                                ...
                                <ul>
                                    <li>
                                        <div>
                                            ...
                                            <h4>Enquiry <em>+65 91695870</em></h4>
                                        </div>
                                    </li>
                                    <li>
                                        <div>
                                            <i class="fa fa-envelope-o" aria-hidden="true"></i>
                                            <h4>Get Support <em>info@TamilThirumanam.com</em></h4>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul>
                                    <li>
                                        <div class="ab-testmo">
                                            ...
                                            <div class="ab-rat-user">
                                                <img src="<?php echo e(asset('users_assets/images/profiles/1.jpg')); ?>" alt="">
                                                <div>
                                                    <h4>John Smith</h4>
                                    ...
                                    <li>
                                        <div class="ab-testmo">
                                            ...
                                            <div class="ab-rat-user">
                                                <img src="<?php echo e(asset('users_assets/images/profiles/6.jpg')); ?>" alt="">
                                                <div>
                                                    <h4>Julia Ann</h4>
                                                    <span>Teacher</span>
                                                </div>
                                    ...
                                    <li>
                                        <div class="ab-testmo">
                                            ...
                                            <div class="ab-rat-user">
                                                <img src="<?php echo e(asset('users_assets/images/profiles/7.jpg')); ?>" alt="">
                                                <div>
                                                    <h4>William Son</h4>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <ul>
                        <li>
                            <div>
                                <img src="<?php echo e(asset('users_assets/images/profiles/6.jpg')); ?>" alt="" loading="lazy">
                                <h4>Ashley Jen</h4>
                        ...
                        <li>
                            <div>
                                <img src="<?php echo e(asset('users_assets/images/profiles/7.jpg')); ?>" alt="" loading="lazy">
                                <h4>Ashley Jen</h4>
                                <p>Marketing Manager</p>
                                <ul class="social-light">
                                    <li><a href="#!"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                        ...
                        <li>
                            <div>
                                <img src="<?php echo e(asset('users_assets/images/profiles/8.jpg')); ?>" alt="" loading="lazy">
                                <h4>Emily Arrov</h4>
                        ...
                        <li>
                            <div>
                                <img src="<?php echo e(asset('users_assets/images/profiles/9.jpg')); ?>" alt="" loading="lazy">
                                <h4>Julia sear</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="ab-faq-rhs">
                            <img src="<?php echo e(asset('users_assets/images/about/3.jpg')); ?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('front/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/us59y3x253l9/public_html/tamilthirumanam.com/resources/views/front/about.blade.php ENDPATH**/ ?>