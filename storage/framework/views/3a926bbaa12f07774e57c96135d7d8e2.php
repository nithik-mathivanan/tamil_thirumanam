...
<head>
	...
	<link rel="stylesheet" href="<?php echo e(asset('public/admin_files/css/switch.css')); ?>">
				...
				<div class="scrollbar-inner sidebar-wrapper" style="margin-top:10%">
					...
					<div>
						...
						<ul class="nav">
							...
							<li class="nav-item">
								<a href="<?php echo e(route('jobtype')); ?>">
									<i class="la la-keyboard-o"></i>
									<p>Job Type</p>
								</a>
							</li>
							...
							<li class="nav-item">
								<a href="<?php echo e(route('familystatus')); ?>">
									<i class="la la-keyboard-o"></i>
									<p>Family Status</p>
								</a>
							</li>
							<li class="nav-item">
								<a href="<?php echo e(route('familytype')); ?>">
									<i class="la la-keyboard-o"></i>
									<p>Family Type</p>
								</a>
							</li>
							<li class="nav-item">
								<a href="<?php echo e(route('familyvalue')); ?>">
									<i class="la la-keyboard-o"></i>
									<p>Family Value</p>
								</a>
							</li>
							<li class="nav-item">
								<a href="<?php echo e(route('parentalstatus')); ?>">
									<i class="la la-keyboard-o"></i>
									<p>Parental Status</p>
								</a>
							</li>
							<li class="nav-item">
								<a href="<?php echo e(route('eatinghabbit')); ?>">
									<i class="la la-keyboard-o"></i>
									<p>Eating Habbit</p>
								</a>
							</li>
							...
							<li class="nav-item">
								<a href="<?php echo e(route('interest')); ?>">
									<i class="la la-keyboard-o"></i>
									<p>Interest</p>
								</a>
							</li>
...
<?php /**PATH C:\xampp\htdocs\tamil_thirumanam\resources\views/superadmin/layout.blade.php ENDPATH**/ ?>