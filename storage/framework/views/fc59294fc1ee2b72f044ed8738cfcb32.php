                                    ...
                                    <form action="<?php echo e(route('profile_details.profile_details_process')); ?>" method="post">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    <select type="text" class="form-control" name="religion" id="religion"
                                                        required>
                                                        <?php if($list->religion!=null): ?>
                                                        <option value="<?php echo e($list->religion); ?>"><?php echo e($list->religion); ?></option>
                                                        <?php else: ?>
                                                        <option value="">Select</option>
                                                        <?php endif; ?>
                                        ...
                                        <div class="edit-pro-parti">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select chosen-select" data-placeholder="Select your Profession" name="jobtype">
                                                    <?php if($list->job_type!=null): ?>
                                                    <option value="<?php echo e($list->job_type); ?>"><?php echo e($list->job_type); ?></option>
                                                    <?php else: ?>
                                                    <option value="">Select</option>
                                                    <?php endif; ?>
                                            ...
                                            <select type="text" class="form-control" name="education" id="education"
                                                required>
                                                    <?php if($list->education!=null): ?>
                                                    <option value="<?php echo e($list->education); ?>"><?php echo e($list->education); ?></option>
                                                    <?php else: ?>
                                                    <option value="">Select</option>
                                                    <?php endif; ?>
                                        ...
                                        <div class="edit-pro-parti">
                                            ...
                                            <div class="row">
                                                ...
                                                <select class="form-select chosen-select" data-placeholder="Select your Family Status" name="family_status">
                                                    <?php if($list->family_status!=null): ?>
                                                    <option value="<?php echo e($list->family_status); ?>"><?php echo e($list->family_status); ?></option>
                                                    <?php else: ?>
                                                    <option value="">Select</option>
                                                    <?php endif; ?>
                                                ...
                                                <select class="form-select chosen-select" data-placeholder="Select your Family Type" name="family_type">
                                                    <?php if($list->family_type!=null): ?>
                                                    <option value="<?php echo e($list->family_type); ?>"><?php echo e($list->family_type); ?></option>
                                                    <?php else: ?>
                                                    <option value="">Select</option>
                                                    <?php endif; ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <select class="form-select chosen-select" data-placeholder="Select your Family Values" name="family_value">
                                                    <?php if($list->family_values!=null): ?>
                                                    <option value="<?php echo e($list->family_values); ?>"><?php echo e($list->family_values); ?></option>
                                                    <?php else: ?>
                                                    <option value="">Select</option>
                                                    <?php endif; ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <?php if($list->f_status!=null): ?>
                                                <option value="<?php echo e($list->f_status); ?>"><?php echo e($list->f_status); ?></option>
                                                <?php else: ?>
                                                <option value="">Select</option>
                                                <?php endif; ?>
                                                ...
                                                <?php if($list->m_status!=null): ?>
                                                <option value="<?php echo e($list->m_status); ?>"><?php echo e($list->m_status); ?></option>
                                                <?php else: ?>
                                                <option value="">Select</option>
                                                <?php endif; ?>
                                                <option value="Working">Working</option>
                                        ...
                                        <div class="edit-pro-parti">
                                            ...
                                            <div class="row">
                                                ...
                                                <?php if($list->eatinghabit!=null): ?>
                                                <option value="<?php echo e($list->eatinghabit); ?>"><?php echo e($list->eatinghabit); ?></option>
                                                <?php else: ?>
                                                <option value="">Select</option>
                                                <?php endif; ?>
...
<?php echo $__env->make('users/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/us59y3x253l9/public_html/tamilthirumanam.com/resources/views/users/profile_details.blade.php ENDPATH**/ ?>