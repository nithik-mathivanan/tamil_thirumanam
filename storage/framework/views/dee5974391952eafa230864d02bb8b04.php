...
<style>
                                                ...
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    <option value="">Select Religion</option>
                                                      <?php $__currentLoopData = $religion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($data->id == $list->religion): ?>
                                                        <option value="<?php echo e($data->id); ?>"selected> <?php echo e($data->religion); ?></option>
                                                        <?php else: ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    <select type="text" class="form-control" name="mother_tongue"
                                                        ...
                                                        <option value="">Select Mother Tongue</option>
                                                            ...
                                                            <?php if($data->id == $list->mothertongue): ?>
                                                                <option value="<?php echo e($data->id); ?>" selected><?php echo e($data->language); ?></option>
                                                            <?php else: ?>
                                                ...
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    <select type="text" class="form-control" name="caste" id="caste" required>
                                                        ...
                                                        <?php if($data->id == $list->caste): ?>
                                                            <option value="<?php echo e($data->id); ?>" selected><?php echo e($data->community); ?></option>
                                                        <?php else: ?>
                                        ...
                                        <div class="edit-pro-parti">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select chosen-select" data-placeholder="Select your Profession" name="jobtype" required>
                                                  ...
                                                  <?php $__currentLoopData = $jobtype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($data->jobtype); ?>" selected=<?php echo e($list->jobtype); ?>><?php echo e($data->jobtype); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                  </select>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <select type="text" class="form-control" name="education" id="education"
                                                required>
                                                    ...
                                                    <?php if($data->education == $list->education): ?>
                                                        <option value="<?php echo e($data->education); ?>" selected><?php echo e($data->education); ?></option>
                                                    <?php else: ?>
                                        ...
                                        <div class="edit-pro-parti">
                                            ...
                                            <div class="row">
                                                ...
                                                <select class="form-select chosen-select" data-placeholder="Select your Family Status" name="family_status" required>
                                                    ...
                                                    <option value="<?php echo e($data->familystatus); ?>" selected=<?php echo e($list->familystatus); ?>><?php echo e($data->familystatus); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                  </select>
                                                </div>
                                                <div class="col-md-6 form-group">
                                                ...
                                                <select class="form-select chosen-select" data-placeholder="Select your Family Type" name="family_type" required>
                                                    ...
                                                    <option value="<?php echo e($data->familytype); ?>" selected=<?php echo e($list->familytype); ?>><?php echo e($data->familytype); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <select class="form-select chosen-select" data-placeholder="Select your Family Values" name="family_value" required>
                                                    ...
                                                    <option value="<?php echo e($data->familyvalue); ?>" selected=<?php echo e($list->familyvalue); ?>><?php echo e($data->familyvalue); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                  </select>
                                                  </div>
                                                  <div class="col-md-6 form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <?php $__currentLoopData = $parentalstatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($data->parentalstatus); ?>" selected=<?php echo e($list->parentalstatus); ?>><?php echo e($data->parentalstatus); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <select class="form-select chosen-select" id="state" name="state" onchange="filterDistricts()" required>
                                                    ...
                                                    <?php $__currentLoopData = $state; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($state->name == $list->state): ?>
                                                            <option value="<?php echo e($state->name); ?>" selected><?php echo e($state->name); ?></option>
                                                        <?php else: ?>
                                                ...
                                                <select class="form-select chosen-select" id="district" name="district" onchange="filterCities()" required>
                                                    <?php $__currentLoopData = $district; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($data->name == $list->district): ?>
                                                    <option value="<?php echo e($data->name); ?>" selected><?php echo e($data->name); ?></option>
                                                    <?php else: ?>
                                        ...
                                        <div class="edit-pro-parti">
                                            ...
                                            <div class="row">
                                                ...
                                                <option value="">Select</option>
                                                 ...
                                                 <option value="<?php echo e($data->eatinghabbit); ?>" selected=<?php echo e($list->eatinghabbit); ?>><?php echo e($data->eatinghabbit); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                 </select>
                                                </div>
                                                <div class="col-md-6 form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <option value="<?php echo e($list->smokinghabit); ?>"selected=<?php echo e($list->smokinghabit); ?>><?php echo e($list->smokinghabit); ?></option>
                                                <?php else: ?>
                                                <option value="">Select</option>
                                                <?php endif; ?>
                                                <option value="No">No</option>
    ...
    $(document).ready(function(){
     ...
     // $(document).ready(function(){
     //    const rel=<?php echo e(Js::from($religion['id'])); ?>;
     //    console.log(rel);
     //    $("#religion").val(rel);
     //  })
...
<?php echo $__env->make('users/layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tamil_thirumanam\resources\views/users/edit_profile_details.blade.php ENDPATH**/ ?>