...
<div class="content">
					<div class="container-fluid">
						<h4 class="page-title" id="ddd">Profile Created By</h4>
							...
							<div class="col-md-8">
								...
								<div class="card">
									<div class="card-header">
										...
										<button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#addModel" data-whatever="@mdo">Create Profile</button>
									</div>
									<div class="card-body">
										...
										<table class="table table-striped mt-3">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<a href="<?php echo e(url('admin/profile/delete')); ?>/<?php echo e($data->id); ?>">
					  ...
					  <div class="modal-dialog" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalLabel">Profile CreatedBy</h5>
					      ...
					      <div class="modal-body">
					          ...
					          <div class="form-group">
					            ...
					            <input class="form-control" name="created_by" placeholder="Enter Creater Name" required>
					          </div>
				...
				<div class="modal fade" id="editModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					  ...
					  <div class="modal-dialog" role="document">
					    <div class="modal-content">
					      ...
					      <div class="modal-body">
					          ...
					          <div class="form-group">
					            <label for="message-text" class="col-form-label">Created By</label>
					            <input class="form-control" name="created_by" id="created_by" placeholder="Enter Profile Name" required>
					          </div>
					...
					<script type="text/javascript">
						...
						function edit(id){
							console.log(id);
							$.ajax({
			                    url:"<?php echo e(url('admin/profile/edit')); ?>/"+id,
			                    type:'GET',
						...
						$(document).ready(function() {
								...
								if($(this).prop('checked')) {
								        $.ajax({
						                    url:"<?php echo e(url('admin/profile/status')); ?>/"+id+'/0',
						                    type:'GET',
						                   	success:function(response){
						                    	Swal.fire({
													  title: 'Profile Activated!!',
													  text: 'Profile status changed successfully',
													  icon: 'success',
								        ...
								        $.ajax({
						                    url:"<?php echo e(url('admin/profile/status')); ?>/"+id+'/1',
						                    type:'GET',
						                   	success:function(response){
						                    	Swal.fire({
...
<?php echo $__env->make('superadmin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tamil_thirumanam\resources\views/superadmin/profile/index.blade.php ENDPATH**/ ?>